...
public class HelpWindow : Window, IDisposable
{
    ...
    public override void Draw()
    {
        ...
        ImGui.Text("The default-off Draw targeting geometry option can visualize the effective cone distance bands, camera direction, and close-target circle for troubleshooting.");
